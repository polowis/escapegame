...
"""bullet_image = pygame.Rect(player.rect.x, player.rect.y, 21, 21)"""
bullet_scale = pygame.transform.scale(assetLibrary['bullet'], (10, 10))
"""bullet_list.append(bullet_image)"""
...
def Intro():
    ...
    if 255 + 110 > cursor[0] > 255 and 250 + 25 > cursor[1] > 200:
    ...
    button1 = button('Game over', (0, 60, 255), 255, 200, 100, 100)
    button2 = button('Play again', (0, 70, 255), 255, 250, 100, 20)
